...
// negated version of filter array method
...
// returns the first occurrence of the company with companyDigit
const findCompany = (invalidCards, companyDigit) => {
  // the card's check digit is compared against the companyDigit parameter
  return invalidCards.find(card => card[card.length - 1] === companyDigit);
};

// searches invalidCards for known companies
const idInvalidCardCompanies = (invalidCards) => {
  ...
  // otherwise, undefined if no company was found
